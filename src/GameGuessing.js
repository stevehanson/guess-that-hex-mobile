...
class GameGuessing extends Component {
  ...
  submit = e => {
    ...
    if (!tinycolor(guess).isValid()) {
      alert(
        "The color you entered is not valid. Please make sure it's a valid 3 or 6 character hex code or a CSS named color."
      );
      return;
    }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text>
          Enter your best guess. When you are finished, click "submit".
        </Text>
        ...
        <View style={styles.form}>
          ...
          {savedGuess && creator && (
            <Button title="Reveal" onPress={onReveal}>
              Reveal
            </Button>
          )}
              ...
              <View style={styles.activity}>
                <View style={{ display: "flex", flexDirection: "row" }}>
                  ...
                  <Text style={styles.activityText}>
                    {donePlayers.join(", ")}{" "}
                    {donePlayers.length === 1 ? "has" : "have"} submitted their
                    guess{donePlayers.length !== 1 && "es"}!
                  </Text>
                </View>
              </View>
            )}
