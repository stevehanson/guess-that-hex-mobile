    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.activity}>
          {players.map(player => (
            <Text style={styles.player} key={player.name}>
        ...
        {creator && (
          <Button title="Start the game" onPress={onStart}>
            Start the game!
          </Button>
        )}
      </View>
